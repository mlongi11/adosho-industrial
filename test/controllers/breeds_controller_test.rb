...
class BreedsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create breed" do
    assert_difference('Breed.count') do
      post breeds_url, params: { breed: { breed_name: @breed.breed_name, species: @breed.species } }
    end
  ...
  test "should update breed" do
    patch breed_url(@breed), params: { breed: { breed_name: @breed.breed_name, species: @breed.species } }
