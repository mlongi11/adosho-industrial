...
class BreedsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create breed" do
    assert_difference('Breed.count') do
      post breeds_url, params: { breed: { breed_id: @breed.breed_id, preferences: @breed.preferences, user_id: @breed.user_id } }
    end
  ...
  test "should update breed" do
    patch breed_url(@breed), params: { breed: { breed_id: @breed.breed_id, preferences: @breed.preferences, user_id: @breed.user_id } }
